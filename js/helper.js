...
var HTMLskillsStart = '<h3 id="skills-h3">技能:</h3><ul id="skills" class="flex-column"></ul>';
...
var HTMLworkDescription = '<br><ul class="workDescription flex-box"></ul>';
var HTMLworkDescriptionItem = '<li class="description-item">%data%</li>';

var HTMLprojectStart = '<div class="project-entry"></div>';
var HTMLprojectTitle = '<a href="#">%data%</a>';
var HTMLprojectDates = '<div class="date-text">%data%</div>';
var HTMLprojectDescription = '<br><ul class="proDescription flex-box"></ul>';
var HTMLprojectDescriptionItem = '<li class="description-item">%data%</li>';
...
var HTMLonlineClasses = '<h3>在线课程</h3>';
